  ...
  if (listed) {
    return (
      <div className="unlist-container">
        ...
        <button className="card__link" onClick={onUnlistButtonClick}>
          Unlist
        </button>
      </div>
    );
    ...
    return (
      <div className="list-container">
        ...
        <div className="form">
          <input className="cardform__input gradient"
            value={duration}
            onChange={onDurationInputChange}
            placeholder="Duration"
            type="text"
          />
          <select className="gradient cardform__input" value={timeUnit} onChange={onTimeUnitChange}>
            <option className="gradient" value={TIME_UNIT_VALUES.HOURS}>hours</option>
            <option className="gradient" value={TIME_UNIT_VALUES.DAYS}>days</option>
            <option className="gradient" value={TIME_UNIT_VALUES.MONTHS}>months</option>
          </select>
        </div>
        ...
        <div className="form">
          <input className="cardform__input gradient"
            ...
            type="text"
          />
          <select className="gradient cardform__input" value={etherUnit} onChange={onEtherUnitChange}>
            <option className="gradient" value={ETHER_UNIT_VALUES.WEI}>wei</option>
            <option className="gradient" value={ETHER_UNIT_VALUES.GWEI}>gwei</option>
            <option className="gradient" value={ETHER_UNIT_VALUES.ETHER}>ether</option>
          </select>
        </div>

        <button className="card__link" onClick={onListButtonClick} disabled={!duration || !price}>
          List
        </button>
      </div>
    );
